...
set(__WIN9X_LINK_FLAGS "-fuse-ld=lld-link -l Kernel32.lib -l User32.lib -l msvcrt.lib")

set(CMAKE_CXX_FLAGS_INIT "${__WIN9X_DEFINES} -g -Wno-unused-command-line-argument -fms-compatibility-version=0 ${__WIN9X_ARCH_FLAGS} ${__WIN9X_INCLUDE_FLAGS} ${__WIN9X_LINK_FLAGS}")
set(CMAKE_C_FLAGS_INIT "${__WIN9X_DEFINES} -g -Wno-unused-command-line-argument -fms-compatibility-version=0 ${__WIN9X_ARCH_FLAGS} ${__WIN9X_INCLUDE_FLAGS} ${__WIN9X_LINK_FLAGS}")
